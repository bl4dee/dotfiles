...
| RAM | 64 GB |
| dGPU | NVIDIA RTX 5090 Mobile, Blackwell GB203 (`10de:2c19`) at `0000:c2:00.0` → `PCI:194:0:0` |
| iGPU | AMD Radeon 890M (`1002:150e`) at `0000:c3:00.0` → `PCI:195:0:0` |
| disk | 1 TB NVMe: ext4 root `f984ee0a-6a04-4790-ae41-5ab20f3e4da1`, vfat ESP `0D91-C9C4`, no swap |
| ethernet | Realtek RTL8125 2.5GbE (`enp192s0`) |
| wifi | MediaTek MT7925 (`wlo1`) — wants a recent kernel, hence `linuxPackages_latest` |
